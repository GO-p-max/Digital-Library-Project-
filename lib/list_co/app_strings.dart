class AppStrings {
  ...
  static const String loginAndRegister = 'Login UI';                                     // * العـنوان الـرئيسي                                                                                   //                                                                                       //
  static const String uhOhPageNotFound = 'uh-oh!\nPage not found';                       // * Taxts APP
  static const String register = 'Register';                                             // * Messages in the APP
  static const String login = 'Login';                                                   // * إعدادات ومكونات التطبيق
  static const String createYourAccount = 'Create your account';                         // *
  static const String doNotHaveAnAccount = "Don't have an account?";                     //
  static const String College = 'University ID';                                         //
  static const String google = 'Google';
  static const String signInToYourNAccount = 'Sign in to your\nAccount';
  static const String signInToYourAccount = '☇ Welcome to digital library';
